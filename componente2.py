...
def generate_provisional_prompts(element):
    ...
    gloss = element[1][1]
    question1 = "Como experto en lingüística, por favor, proporciona diez frases donde la palabra '" + word + "' se utilice en género masculino en todo momento, con el sentido de '" + gloss + "'. Cada frase debe contener la palabra '" + word + "' en género masculino, asegurándote de mantener este género en todas las instancias dentro de la frase."
    question2 = "Como experto en lingüística, por favor, proporciona diez frases donde la palabra '" + word + "' se utilice en género femenino en todo momento, con el sentido de '" + gloss + "'. Cada frase debe contener la palabra '" + word + "' en género femenino, asegurándote de mantener este género en todas las instancias dentro de la frase."
...
def generate_validation_prompts(element, provisional_answer):
    ...
    word = offset_word.split('_')[1]
    gloss = element[1][1]
    question = "Como experto en lingüística, por favor, proporciona diez frases donde la palabra '" + word + "' se utilice en género '" + provisional_answer + "' en todo momento, con el sentido de '" + gloss + "'. Cada frase debe contener la palabra '" + word + "' en género '" + provisional_answer + "', asegurándote de mantener este género en todas las instancias dentro de la frase."
